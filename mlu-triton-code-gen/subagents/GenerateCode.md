...
读取 step4_code_spec.json 和 `ref/mlu_supported_primitives.md`，获取：
...
- **原语约束**：必须遵守 `.claude/skills/mlu-triton-code-gen/ref/mlu_supported_primitives.md`，不得主动生成其中禁止的原语。
...
- **🚫 禁止**主动生成 `.claude/skills/mlu-triton-code-gen/ref/mlu_supported_primitives.md` 中列出的禁用原语

...
执行前同时读取 `.claude/skills/share/mlu/references/libdevice.md` 和 `.claude/skills/share/mlu/references/platform-rules.md`。具体 API/dtype 支持以共享 Libdevice 文档为准，本策略只负责模式识别、替换和实测验证。
